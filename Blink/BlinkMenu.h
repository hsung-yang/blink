...
extern const BlinkActionID BlinkActionSplitHorizontal;
extern const BlinkActionID BlinkActionSplitVertical;
extern const BlinkActionID BlinkActionClosePane;
